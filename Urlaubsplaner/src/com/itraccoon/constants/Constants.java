...
public class Constants {
    ...
    public static String   EXPORT_LOCATION   = SYS_USERHOME + SEPARATOR + "Desktop" + SEPARATOR + "Urlaubsplaner_Export.xml";
    
    // Logfile location
    public static String   LOGFILE_LOCATION  = DATABASE_LOCATION;
