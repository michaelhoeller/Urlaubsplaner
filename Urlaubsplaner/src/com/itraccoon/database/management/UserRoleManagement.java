...
public class UserRoleManagement {
    ...
    public static Integer getSpecificUserRoleByValue(String userRoleValue) throws SpecificUserRoleException {
        HashMap<Integer, String> allRoles = getAllUserroles();
        Integer specificUserRoleId = Utils.getKeyFromValue(allRoles, userRoleValue);
        if (specificUserRoleId == null) {
            throw new SpecificUserRoleException();
        }
        
        return specificUserRoleId;
    }
