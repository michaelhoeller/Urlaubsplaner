...
public class UserManagement {
    ...
    public static User getUserById(Integer id) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                user.setDaysSpent(rs.getFloat("USER_DAYS_SPENT"));
                user.setDaysRemaining(rs.getFloat("USER_DAYS_REMAINING"));
                user.setDaysPerYear(rs.getFloat("USER_DAYS_PER_YEAR"));
    ...
    public static List<User> getAllUsers() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                userToAdd.setDaysSpent(rs.getFloat("USER_DAYS_SPENT"));
                userToAdd.setDaysRemaining(rs.getFloat("USER_DAYS_REMAINING"));
                userToAdd.setDaysPerYear(rs.getFloat("USER_DAYS_PER_YEAR"));
    ...
    public static void updateUser(User user) {
        ...
        try {
            ...
            stmt.setFloat(2, user.getDaysSpent());
            stmt.setFloat(3, user.getDaysRemaining());
            stmt.setFloat(4, user.getDaysPerYear());
    ...
    public static void insertNewUser(String name, Float daysSpent, Float daysRemaining, Float daysPerYear, Integer userRole) {
